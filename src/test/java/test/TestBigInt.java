...
//		code_v4_("var a = [12L, ''] var b = a[0]; return ~b;").equals("-13");
		...
		// TODO : for all operators, set return type to ANY if Object (in LeekExpression and Type)
...
//		 code_v4_("var a = 12L a \\= [] a").exception(ls::vm::Exception::NO_SUCH_OPERATOR);
		...
		*/
		...
		code_v4_("var a = 5.5 a = 2L ** 100").equals("1267650600228229401496703205376");
		...
		code_v4_("return number(1267650600228229401496703205376)").equals("1267650600228229401496703205376");
		code_v4_("return number('1267650600228229401496703205376')").equals("1267650600228229401496703205376");
